...
export async function POST(req: Request) {
    ...
    try {
        ...
        4. **뉴스/이슈/무슨일**: 오늘 뉴스, 사회 소식 등 정보 요청이 있으면 **반드시 'searchNewsKeyword'**에 검색어를 넣으세요. 
           - **해외/국제 뉴스 (우선순위)**: "해외", "국제", "지구촌", "미국", "일본", "유럽" 등 국외 관련 단어가 하나라도 있으면 **무조건 "INTL_HOT_NEWS"**라고 키워드를 생성하세요. 사용자가 나라 이름을 말해도 일단 전체적인 해외 핫뉴스를 보여주기 위해 "INTL_HOT_NEWS"를 사용합니다.
           - **국내 뉴스**: 위 조건이 아니고 "뉴스", "소식", "무슨 일" 등 일반적인 요청에는 **"HOT_NEWS"**라고 키워드를 생성하세요.
           - 특정 기업(예: "삼성전자 뉴스") 같이 아주 좁은 주제일 때만 해당 주제를 키워드로 쓰세요.
