...
export async function POST(req: Request) {
    ...
    try {
        ...
        4. **뉴스/이슈/무슨일**: 오늘 뉴스, 사회 소식 등 정보 요청이 있으면 **반드시 'searchNewsKeyword'**에 검색어를 넣으세요. "뉴스 알려줘", "무슨 일 있니?", "세상 돌아가는 소식" 같은 요청에는 **무조건 "HOT_NEWS"**라고 키워드를 생성하세요. 특정 주제(예: "삼성전자 뉴스")가 있을 때만 해당 주제를 키워드로 쓰세요.
